...
public class ActiveShoppingListItemsModule {
    ...
    @ActiveShoppingListItemsScope
    @Provides
    public ItemDisplayPresenter itemDisplayPresenter(ItemDisplayView itemDisplayView, ItemDao itemDao, ShoppingListDao shoppingListDao, ShoppingListService shoppingListService, SharedPreferencesManager sharedPreferencesManager, NetworkUtil networkUtil) {
        return new ItemDisplayPresenterImpl(itemDisplayView, itemDao, shoppingListDao, shoppingListService, sharedPreferencesManager, networkUtil);
    }
